...
/*
#cgo CFLAGS: -I${SRCDIR}/webview/include
#cgo CXXFLAGS: -I${SRCDIR}/webview/include -DWEBVIEW_STATIC
...
#cgo windows CXXFLAGS: -DWEBVIEW_EDGE -std=c++14 -I${SRCDIR}/mswebview2/include
